import simulation, { getMinutePrice, getTotal } from '../index';
...
describe('src/lib/index/getMinutePrice()', () => {
  ...
  it(`from ${ddd1} to ${ddd2}`, () => {
    expect(getMinutePrice(ddd1, ddd2, priceTable)).toBe(1.9);
  });

  it(`from ${ddd2} to ${ddd1}`, () => {
    expect(getMinutePrice(ddd2, ddd1, priceTable)).toBe(2.9);
  });

  it(`from ${ddd1} to ${ddd3}`, () => {
    expect(getMinutePrice(ddd1, ddd3, priceTable)).toBe(1.7);
  });

  it(`from ${ddd3} to ${ddd1}`, () => {
    expect(getMinutePrice(ddd3, ddd1, priceTable)).toBe(2.7);
  });

  it(`from ${ddd1} to ${ddd4}`, () => {
    expect(getMinutePrice(ddd1, ddd4, priceTable)).toBe(0.9);
  });

  it(`from ${ddd4} to ${ddd1}`, () => {
    expect(getMinutePrice(ddd4, ddd1, priceTable)).toBe(1.9);
  });
});
...
describe('default export: simulation()', () => {
  it('ddd1 = 11, ddd2 = 16, minutes = 20', () => {
    const [plan0, plan30, plan60, plan120] = simulation(11, 16, 20);
  ...
  it('ddd1 = 11, ddd2 = 17, minutes = 80', () => {
    const [plan0, plan30, plan60, plan120] = simulation(11, 17, 80);
